...
The mistake is to run a confirmatory test on an unexplored question. You will get a crisp, confident answer to the wrong question — efficient failure. If you cannot yet write a grounded hypothesis (you saw how in the chapter on [writing a proper hypothesis](ch09-hypothesizing.qmd), and how to build the grounding through [exploration](exploring.qmd)), your next experiment is an exploration, not a test. Confirm only what exploration has earned.
