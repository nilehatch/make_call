# Exploring {#sec-exploration-chapter}
...
Every hypothesis needs some degree of [groundedness](ch09-hypothesizing.qmd#sec-groundedness-sec) — it can’t just be plucked from thin air. But when uncertainty is high, you don’t yet have enough grounding to form a strong hypothesis.  

That’s where exploration comes in. Exploration is the work of *building groundedness*. Through observation, conversations, and small probes, you collect the raw signals that give your future hypotheses roots in reality.  

Think of it as shifting your position on @fig-groundedness-threshold, the *groundedness–uncertainty map*: exploration moves you from “high uncertainty, low groundedness” toward the threshold where hypotheses make sense.  

## What Exploration Looks Like  

Exploration is structured wandering. Philosopher Ian Hacking [-@hackingEmergenceProbabilityPhilosophical2006] described this type of experiment as **adventure** — deliberately stepping into the world, not to confirm what you know, but to experience it and then shape it by what you discover.  
...
4a. **Check for grounding.** Ask: *Do I now have enough concrete signals to form a testable hypothesis?* If not, keep exploring.  
...
By listening before pitching, the FitNest team moved their ideas from **low groundedness** (a hunch about workouts) to **higher groundedness** (clear signals around nutrition and energy). That shift made their next hypotheses sharper and more useful.  
...
3. Ask yourself: *Do these surprises feel grounded enough to build a testable hypothesis?*  
   - If yes, draft the hypothesis using the template from the last chapter.  
   - If not, note what’s still missing and plan one more round of exploration.  
4. Turn at least one surprise into a possible explanation (*abduction*).  
5. Draft a hypothesis you could test next week.  

By the end, you’ll have gone from *fog → surprise → grounded signal → abductive leap → testable hypothesis*.  
:::