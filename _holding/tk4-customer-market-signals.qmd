...
This toolkit should be used with the principles and methods outlined in [Chapter @sec-competitor-market-signals-chapter].
...
*Look for what competitors are legally required to say, not what they want you to hear.*

#### Sources & Signals  
- **10-K / Annual Reports:** Strategic priorities, segment performance, risk factors.  
- **10-Q / Quarterly Reports:** Short-term performance shifts and experiments.  
- **Investor Letters & Earnings Calls:** Forward-looking narratives and tone changes.  

#### What to Watch For  
- **Language shifts:** New focus words (e.g., “AI,” “sustainability”) often precede investment moves.  
- **Margins by segment:** Reveal where competitors actually make or lose money.  
- **R&D and marketing spend:** Show changing strategic bets.  
- **Customer concentration or churn metrics:** Hidden dependencies or fragility.

::: {.callout-note appearance="minimal"}
### Mini-Guide: Reading a 10-K for Strategy Clues
1. Go to [sec.gov/edgar](https://www.sec.gov/edgar/searchedgar/companysearch.html) and search a public company.  
2. Open its most recent **10-K**.  
3. Skim three sections:
   - **Item 1A – Risk Factors** → what they’re worried about.  
   - **Item 7 – MD&A** → how they explain performance changes.  
   - **Financial Statements** → where money flows.  
4. Note 2–3 insights that a startup could learn from — e.g., a growing cost line, a new competitive threat.

*Lesson: Extract real competitive context from regulated transparency.*
:::
