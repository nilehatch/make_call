...
Put your own decision through it. Start with the population your product belongs to: the new products launched in a category like yours over a year, say a thousand IoT gadgets or a thousand new consumer apps. Most of them fail. Suppose that of every 1,000, only about 100 turn out to be genuinely wanted; the other 900 flop. That 100-in-1,000 is your **base rate**, the [prior](prior-you-have-one.qmd) you carried in from the last chapters: one in ten. (The one-in-ten here is illustrative; the real figure varies by category and is notoriously slippery to pin down, so use the best number you can actually defend for yours.)
...
What you just did by counting is what a prior is *for*. The base rate, 1 in 10, was your prior. The “yes” was your evidence. The number you read off the tree, about 1 in 3, is your posterior: your belief after the evidence. You updated a prior into a posterior and never touched an equation.[^chivers]
...
::: {.worked-example}
**Worked example — Halo's update, part by part**

The same four pieces, on the venture we have been following. Halo's question: *will women switch from their phone to the ring?*

- **Prior** — their honest starting belief before the interviews, built from two founders' lived fear and the base rates of the space. Well-grounded on *the problem* (women feel unsafe), but only hopeful on *the switch* (that they would adopt a device).
- **Evidence** — a handful of interviews leaning their way.
- **Likelihood** — how much that evidence *discriminates*: whether a warm interview is likelier from a woman who would switch than from one who would not. Warm words come from both, so the interviews fit the two stories almost equally: a weak signal, like a test with a high false-yes rate.
- **Posterior** — the belief after the evidence: the prior nudged, not moved. A weak signal against a prior already carrying the weight leaves you close to where you started — *enough to press on, not enough to build.*

There is no new number here, because the decisive test is still ahead. But the shape is already clear: a soft likelihood and thin evidence leave the posterior sitting close to the prior. Which piece is which is the thing to hold onto. Name them on your own decision and the arithmetic takes care of itself.
:::
...
[^ellenberg]: The idea that mathematical trouble is usually a failure of *format* rather than of the person, and that rigor can be made to feel like common sense extended, runs throughout @ellenbergHowNotBe2014, and is the animating spirit of this whole book.

[^chivers]: For an accessible tour of how far this single move, updating a prior into a posterior, reaches across science and everyday life, see @chiversEverythingPredictableHow2024.
