...
A result is not a fact. It is a signal, arriving through noise, produced by particular people under particular conditions, and it carries exactly as much weight as its making can bear, and no more. The fog does worse than hide the answer — it disguises weak answers as strong ones. And a weak answer believed is worse than no answer at all, because you will act on it.
...
4. Give it a weight, heavy or moderate or barely any, and decide whether the action you took (or planned) matches that weight.
