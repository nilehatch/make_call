...
**Does it agree with what else you know?** A single result is a single witness. When it converges with other sources it earns weight; when it contradicts them, the disagreement is not noise to be smoothed away — it is your next question. [Triangulate](seeing-in-depth.qmd) before you trust.
