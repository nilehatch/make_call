...
**Does it agree with what else you know?** A single result is a single witness. Set it beside the evidence you already [triangulated](seeing-in-depth.qmd). A result that converges with independent sources has earned weight; one that stands alone, or contradicts the rest, has not yet earned it. Corroboration is part of credibility.
