...
ggplot() +
  ...
  annotate("segment", x = 0.20, y = 0.47, xend = 0.60, yend = 0.47, color = "#1F2937", linewidth = 0.7, arrow = arrow(length = unit(0.18, "cm"), type = "closed")) +
  annotate("text", x = 0.40, y = 0.525, label = "exploration builds groundedness", color = "#1F2937", size = 3, fontface = 3) +
